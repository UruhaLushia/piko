...
func newPartScheduler(size int64, initialPartSize int64, concurrency int, pending []downloadSpan, strategy ConcurrencyStrategy) *partScheduler {
	...
	if strategy != ConcurrencyStrategyAdaptive {
